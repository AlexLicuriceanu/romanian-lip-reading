...
ASD_MIN_TRACK = 10 # Number of min frames for each shot
ASD_NUM_FAILED_DET = 10 # Number of missed detections allowed before tracking is stopped
ASD_DURATION_SET = {2, 3, 4} # {1,2,4,6} - Slower, more reliable or {1,1,1,2,2,2,3,3,4,5,6} - Even slower, even more reliable 
